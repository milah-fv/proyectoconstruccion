                ...
                <center>
                    <table cellspacing="0" cellpadding="0" width="600" class="w320">
                        ...
                        @if($order->payment->payment_type_id == 1)
                            <tr>
                                <td class="free-text">
                                    Le avisaremos tan pronto como se hayan enviado sus artículos. Para cambiar o ver su pedido, vea su cuenta haciendo clic en el botón a continuación.
                                </td>
                            </tr>
                        @else
                            <tr>
                        ...
                        <tr>
                            ...
                            <![endif]--><a href="{{ url('/profile/orders/'.$order->getIdFormat()) }}"
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                                                            ...
                                                            <td class="mini-block">
                                                                <span class="header-sm">Cuenta bancaria:</span><br />
                                                                    ...
                                                                    <b>Banco</b> BCP <br />     
                                                                    <b>Número de cuenta</b> 111112222223333330000 <br />                                                                                                                                                                                           
                                                            </td>
                                                            </tr>
                                                        </table>
                                                        </td>
