            ...
            <div class="card-body row">
                <div class="col-md-3">
                    <div class="list-group">
                        ...
                        <a href="javascript:void(0)" class="list-group-item list-pibe list-group-item-action active" id="list_orders_list">Ventas por fecha</a>
    ...
    $(document).ready(function() 
    {
        ...
        function fetch_data(date_init='', date_end='')
        {
            $('#table_report').dataTable( 
            {
                ...
                "ajax" : 
                {
                    url:"{{ url('admin/reports/purchases') }}",
                    type:"POST",
                    data:
                    {
